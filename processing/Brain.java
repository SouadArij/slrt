...
public class Brain implements Runnable {
    ...
    private static final double MINIMUM_RATE_NEEDED_TO_MATCH = 0.1;
    private static final double MINIMUM_PROPORTION_OF_IMAGES_NEEDED_TO_MATCH = 0.0001;
        ...
        while (true) {
            ...
            while (this.algorithmRunning) {
                ...
                if (this.capturedImageChanged) {
                    ...
                    System.out.format("Brain: compared with %d letters, maxMatchedDouble = %.3f, maxMatchedIndex = %d.\n", letterIndex, maxMatchedDouble, maxMatchedIndex);
