...
public class DBImage {
    ...
    private static String SIGNATURE = "<Sign Language Recognition and Translation database image file>";
    private static int N_ANGLES = 5;

    private static int DB_IMAGE_WIDTH = 320;
    private static int DB_IMAGE_HEIGHT = 240;
    private static int CONTOUR_POWER = 2;
    private static double WHITE_PROPORTION = 0.04;
    private static int HV_AREA_LIMIT = 400;
    private static int THINNESS = 5;
    private static int OUTER_TRIES = 10;
    private static int INNER_TRIES = 10;
    private static double ANGLE_THINNESS = 8.0;
    private static int AREA_LOWER_LIMIT = 280;
    private static int AREA_HIGHER_LIMIT = 600;
    ...
    public static DBImage loadRawFromDisk(File file) {
        ...
        leftShape = ImageAlgorithms.reduceShapeHVAreaLimit(greatestShape, leftMostPoint, THINNESS, true, HV_AREA_LIMIT);
        rightShape = ImageAlgorithms.reduceShapeHVAreaLimit(greatestShape, rightMostPoint, THINNESS, true, HV_AREA_LIMIT);
        topShape = ImageAlgorithms.reduceShapeHVAreaLimit(greatestShape, topMostPoint, THINNESS, false, HV_AREA_LIMIT);
        bottomShape = ImageAlgorithms.reduceShapeHVAreaLimit(greatestShape, bottomMostPoint, THINNESS, false, HV_AREA_LIMIT);
    ...
    public static DBImage getInstanceFromRawMemory(BufferedImage rawIm) {
        ...
        Shape[] thinShapes = ImageAlgorithms.findThinShapes(greatestShape, N_ANGLES, OUTER_TRIES, INNER_TRIES, ANGLE_THINNESS, AREA_LOWER_LIMIT, AREA_HIGHER_LIMIT);
        double rotation = 0.0;        
